...
from .views import SignUpView, ProfileView, ProfileUpdateView, profile_email_notification
...
urlpatterns = [
    ...
    path('profile/notification/', profile_email_notification, name='profile_email_notification'),
